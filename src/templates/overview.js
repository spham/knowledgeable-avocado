                  ...
                  <div class="block-items">
                    {_.map(_.get(this.props, 'pageContext.site.data.doc_sections.sections'), (section, section_idx) => {
                        ...
                        return (<React.Fragment key={section_idx}>
                          <section key={section_idx} class="block-item">
                            <div class="block-item-inside">
                              ...
                              {_.get(section_page, 'frontmatter.excerpt') && <React.Fragment>
                                <p class="block-item-text">{htmlToReact(_.get(section_page, 'frontmatter.excerpt'))}</p>
                                <p class="block-item-cta"><Link to={safePrefix(_.get(section_page, 'url'))}>Learn More <span class="icon-arrow-right" aria-hidden="true" /></Link></p>
                              </React.Fragment>}
                            </div>
                          </section>
                        </React.Fragment>)
